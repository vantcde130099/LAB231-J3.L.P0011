...
<body>
    <div class="container" id="big">
        <div class="container-fluid header-wrapper">
            ...
            <nav class="navbar navbar-expand navbar-light bg-light pt-2">
                <div class="nav navbar-nav">
                    <a class="nav-item nav-link" href="index.jsp">My Blog <span class="sr-only">(current)</span></a>
                ...
                <div class="col-sm-4">
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <div class="p-1">
                                <ul>
                                    <li><a id="share-facebook" href="#"><i
                                                class="fab fa-facebook-square"></i></i><span>Share on
                                                Facebook</span></a></li>
                                    <li><a id="share-twitter" href="#"><i
        ...
        <div class="container">
            <div class="footer">
                <span>This website was created with team1</span>
